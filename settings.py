...
player1_img = pygame.image.load(path.join(game_folder, 'bad-ninja1---drawing.png')).convert()
player2_img = pygame.image.load(path.join(game_folder, 'platformChar_jump.png')).convert()
